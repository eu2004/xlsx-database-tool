...
IZPACK_JAVA_HOME=C:\Program Files\Java\jre1.8.0_77
...
# SQuirreL home.
if $macosx ; then
	SQUIRREL_SQL_HOME='D:\workspace\xlsxdb\xlsxdb\dist\squirrel/Contents/Resources/Java'
else 
	SQUIRREL_SQL_HOME='D:\workspace\xlsxdb\xlsxdb\dist\squirrel'
fi
